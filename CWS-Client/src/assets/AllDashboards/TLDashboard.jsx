  ...
  const fetchData = async () => {
    try {
      const leavesRes = await axios.get(
        `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/leave/team-leader/${user._id}`,
      );
      setLeaves(leavesRes.data.leaves || []);
      
      const regRes = await axios.get(
        `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/regularization/team-leader/${user._id}`,
      );
