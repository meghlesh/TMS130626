...
function EmployeeApplyLeave({ user, onLeaveApplied }) {
    ...
    const fetchTeamLeaders = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/employee/${user._id}/team-leader`,
          {
            headers: { 'Authorization': `Bearer ${token}` }
          }
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const existingLeavesRes = await axios.get(`https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/leave/my/${user._id}`);
  ...
  const getApplyToValue = () => {
    ...
    const confirmApplyLeave = async () => {
      ...
      try {
        ...
        await axios.post(
          "https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/leave/apply",
          {
            employeeId: user._id,
            leaveType: form.leaveType,
            dateFrom: dateFromParsed,
