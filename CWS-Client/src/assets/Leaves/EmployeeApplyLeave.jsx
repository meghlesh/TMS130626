...
function EmployeeApplyLeave({ user, onLeaveApplied }) {
    ...
    const fetchTeamLeaders = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/employee/${user._id}/team-leader`,
          {
            headers: { 'Authorization': `Bearer ${token}` }
          }
        );
  ...
  useEffect(() => {
    const fetchManager = async () => {
      ...
      try {
        ...
        const res = await axios.get(`api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/users/${user.reportingManager}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // const existingLeavesRes = await axios.get(`api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/leave/my/${user._id}`);
  ...
  const getApplyToValue = () => {
    ...
    const confirmApplyLeave = async () => {
      ...
      try {
        ...
        await axios.post(
          "api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/leave/apply",
          {
            employeeId: user._id,
            leaveType: form.leaveType,
            dateFrom: dateFromParsed,
