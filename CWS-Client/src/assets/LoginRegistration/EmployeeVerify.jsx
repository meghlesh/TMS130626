...
//           `api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/employee/verify/${id}/${token}`
//         );
...
//         `api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/employee/set-password`,
//         { id, token, password }
//       );
